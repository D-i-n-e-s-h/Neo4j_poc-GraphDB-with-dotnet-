...
namespace MoviesDotNetCore.Repositories
{
    public interface IMovieRepository
    {
        ...
        Task<int> UpdateTitle(string title, string UpdatedTitle);
        Task<List<Movie>> Search(string search);
        Task<D3Graph> FetchD3Graph(int limit);
        Task<int> DeleteByTitle(string title);
    }
    ...
    public class MovieRepository : IMovieRepository
    {
        ...
        public async Task<int> UpdateTitle(string title, string UpdatedTitle)
        {
            var session = _driver.AsyncSession(WithDatabase);
            try
            {
        ...
        public async Task<int> DeleteByTitle(string title)
        {
            var session = _driver.AsyncSession(WithDatabase);
            try
            {
